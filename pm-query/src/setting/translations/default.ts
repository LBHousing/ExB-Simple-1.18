export default {
  ...
  resultsLayerTitlePlaceholder: 'PMQuery Results',
  ...
  shnLayerTitle: 'Road network layer (optional)',
  shnLayerTitlePlaceholder: 'State Highway Network Lines - Caltrans',
  shnLayerTitleDescription: 'Enter the exact name of a polyline layer already added to your map. When set, the line will trace actual road geometry instead of connecting points with straight segments. Uses Route, Direction, and Odometer fields to find the matching segment.',
